...
\newcommand{\msgheaderNotify}[1]{\rowcolor{yellow!50!}\msgvalues{Message Type}{4}{ Value set to #1} \rowcolor{yellow!50!}\msgvalues{Message ID}{ushort}{Message ID} \hline}
