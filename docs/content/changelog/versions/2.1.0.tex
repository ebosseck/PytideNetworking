...
\begin{itemize}
	\chitem{DisconnectReason: Added PoorConnection item}
	\brchitem{MessageHeader: Removed AckExtra, added Notify. This decrements the values for Connect, Reject, Heartbeat and Disconnect by one}
	\chitem{ConnectionState: Removed Rejected State}
\end{itemize}
...
\subsection{Methods}
\begin{itemize}
	\item \textbf{Added:} Disconnect(Connection, DisconnenctReason) (abstract, no implementation)
\end{itemize}
